...
#gmd start --rollkit.aggregator true --rollkit.da_layer avail --rollkit.da_config='{"seed":"bottom drive obey lake curtain smoke basket hold race lonely fit walk//Alice","api_url":"ws://127.0.0.1:9944","size":1000,"app_id" : 0}' --rollkit.namespace_id $NAMESPACE_ID --rollkit.da_start_height $DA_BLOCK_HEIGHT
...
gmd start --rollkit.aggregator true --rollkit.da_layer avail --rollkit.da_config='{ "seed":"bottom drive obey lake curtain smoke basket hold race lonely fit walk//Alice","api_url":"ws://127.0.0.1:9944","size":1000,"app_id" : 0}' --rollkit.namespace_id $NAMESPACE_ID --rollkit.da_start_height 149448 --api.enable --api.enabled-unsafe-cors
